...
<?php 
     if($_POST['register']){
        ...
        if($p != $cp){
            ...
            $tblquery = "INSERT INTO users VALUES(:id, :fn, :ln, :email, :pn, :password, :state, :branch, :location, :ms, :date, :level, :sex, :picture, :last_login, :status)";
            $tblvalue = array(
                ':id' => NULL,
                ...
                ':state' => htmlspecialchars(ucwords($stateLocation)),
                ':branch' => htmlspecialchars(ucwords($branchName)),
                ':location' => htmlspecialchars(ucwords($branchLocation)),
...
<head>
    ...
    <title>Registration | Jessica's Food Restaurant</title>
    <link rel="shortcut icon" type="image/png" href="upload/rice.jpg">
                ...
                <div class="wrapper-box">
                    ...
                    <form action="registration.php" method="POST">
                        <div class="form-box">
                            ...
                            <label for="state">Restaurant Location</label>
                            <input type="text" id="state" name="stateLocation" placeholder="Enter State Location" required>

                            <label for="bl">Branch Location</label>
                            <input type="text" id="bl" name="branchLocation" placeholder="Enter Branch Location" required>

                            <label for="bn">Branch Name</label>
                            <input type="text" id="bn" name="branchName" placeholder="Enter Branch Name" required>
